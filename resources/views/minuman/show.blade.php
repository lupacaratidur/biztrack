<div class="modal fade" tabindex="-1" role="dialog" id="modal_detail_minuman">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Detail Minuman</h5>
        ...
        <form enctype="multipart/form-data">
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">     
                        <input type="hidden" id="minuman_id">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_minuman" id="detail_nama_minuman" disabled readonly>
                            <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-nama_minuman"></div>
                        </div>
